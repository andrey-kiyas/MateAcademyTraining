...
public class LC3508ImplementRouter {
    public static void main(String[] args) {
        ...
        System.out.println(router.addPacket(1, 4, 90));  // false (дубликат)
        System.out.println(router.addPacket(3, 5, 95));  // true
        System.out.println(router.addPacket(4, 5, 105)); // true, старый [1,4,90] удалён
        System.out.println(Arrays.toString(router.forwardPacket())); // [2,5,90]
        System.out.println(router.addPacket(5, 2, 110)); // true
        System.out.println(router.getCount(5, 100, 110)); // 1 ([4,5,105])
    }
}
