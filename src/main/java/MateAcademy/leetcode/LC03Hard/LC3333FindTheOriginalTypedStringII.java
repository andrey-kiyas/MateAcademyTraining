...
public class LC3333FindTheOriginalTypedStringII {
    private static final int MOD = 1_000_000_007;

    public static void main(String[] args) {
        System.out.println(possibleStringCount("aabbccdd", 7)); // 5
        System.out.println(possibleStringCount("aabbccdd", 8)); // 1
        System.out.println(possibleStringCount("aaabbb", 3));   // 8
    }
