...
public class LC3445MaximumDifferenceBetweenEvenAndOddFrequencyII {
    public static void main(String[] args) {
        System.out.println(maxDifference("12233", 4));     // -1
        System.out.println(maxDifference("1122211", 3));   // 1
        System.out.println(maxDifference("110", 3));       // -1
    }
